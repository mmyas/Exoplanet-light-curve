...
#  Generated by /MS/rh20ms112/phantom/scripts/writemake.sh: Thursday 04 April 2024 05:16:18 PM IST
#
PHANTOMDIR=/MS/rh20ms112/phantom/
SPLASHDIR=/MS/rh20ms112/splash
EDITOR=vi
ifndef SETUP
SETUP=disc
endif
...
analysis:
	cd ${PHANTOMDIR}; make RUNDIR=${PWD} SETUP=${SETUP} phantomanalysis; cd -; cp ${PHANTOMDIR}/bin/phantomanalysis .
phantomlib:
